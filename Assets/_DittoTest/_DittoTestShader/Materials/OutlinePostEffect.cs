...
public class OutlinePostEffect : PostEffectBase
{
   ...
   // public Color outlineColor = Color.green;
    ...
    private void InitAdditionalCam()
    {
        ...
        Transform addCamTransform = transform.Find("FauxGravityBodyLayer");
        if (addCamTransform != null)
            DestroyImmediate(addCamTransform.gameObject);

        GameObject additionalCamObj = new GameObject("FauxGravityBodyLayer");
    ...
    private void SetAdditionalCam()
    {
        if (additionalCam)
        {
            ...
            additionalCam.cullingMask = 1 << LayerMask.NameToLayer("FauxGravityBodyLayer");
    ...
    void OnRenderImage(RenderTexture source, RenderTexture destination)
    {
        if (_Material && renderTexture)
        {
            ...
            Graphics.Blit(source, temp2, _Material, 2);


            //扭曲
           Graphics.Blit(temp2, destination, _Material, 3);
